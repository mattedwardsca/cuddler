...
public static class LoggedInAccountExtensions
{
    ...
    public static IAccount GetLoggedInAccount(this HttpContext httpContext)
    {
        ...
        return (IAccount)getAccountEntityById!;
    }
    ...
    private static IAccount? Get(HttpContext httpContext, string userId)
    {
        var repository = httpContext.GetService<IRepository>();
        return (IAccount?)repository.DbSet("AccountEntity")!.AsNoTracking()

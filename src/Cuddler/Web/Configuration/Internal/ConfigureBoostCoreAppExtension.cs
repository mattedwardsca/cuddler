...
internal static class ConfigureBoostCoreAppExtension
{
            ...
            app.UseExceptionHandler(errorApp => errorApp.Run(async context => {
                ...
                switch (exception)
                {
                    case InvalidClaimException:
                        var signInManager = ViewContextExtensions.GetService<SignInManager<AccountEntity>>(context);
    ...
    private static void UseXForwardedHeaders(IApplicationBuilder app)
    {

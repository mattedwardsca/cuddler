...
public class CuddlerFormGridFields<TModel> : GridCuddlerFormFields where TModel : class
{
    public CuddlerFormGridFields() : base(typeof(TModel))
    {
    }

    public Type ModelType => typeof(TModel);

    public CuddlerFormGridFields<TModel> Bind(object obj)
    {
        Model = obj;
    ...
    public CuddlerFormGridFields<TModel> Schema(Action<GridPropertyFactory<TModel>> configurator)
    {
